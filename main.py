...
target={'BKK': ['VTBS','Bang Kok'],'PEK': ['ZBAA','BeiJing'],'TFU': ['ZUUU','ChengDu Tianfu'],'DAD': ['VVDN','Da Nang'],'DEL': ['VIDP','Delhi'],
        ...
        'CJU':['RKPC','Jeju'],'FOC':['ZSFZ','Fu Zhou'],'WUH':['ZHHH','Wu Han'],'CTU':['ZUUU','Chengdu Shuangliu'],'NGB':['ZSNB','Ningbo']}
